 ...
 */
class pdf_commande extends ModelePDFCommandes
{
    ...
    function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
    {
        ...
        if ($conf->commande->dir_output) {
            ...
            if (file_exists($dir)) {
                ...
                $montantHt = ($conf->multicurrency->enabled && $object->mylticurrency_tx != 1 ? $object->multicurrency_total_ht : $object->total_ht);
                // Total HT
                ...
                // Total TVA
                    if ($object->total_tva > 0){
                        $table .= '<tr><td></td>';
                        $table .= '<td align="right" style="border-bottom:1px solid #000;">' . $outputlangs->transnoentities("Total TVA") . '</td>';
                ...
                $table .= '</table>';
                $table .= '<p><span style="font-weight: normal">Montant en lettres : </span><span style="font-weight: bold">' . $total_ttc_lettre . ' Francs CFA</span></p>';
                $pdf->writeHTML($table, true, 0, true, true);
                // Affiche zone infos
    ...
    function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
    {
        ...
        //Date
        $table .= '<span style="font-size:10pt">' . $outputlangs->transnoentities("OrderDate") . " : " . dol_print_date($object->date, "day", false, $outputlangs, true) . '</span><br/>';
